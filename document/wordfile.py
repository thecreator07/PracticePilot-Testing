...
def create_patient_docx(llm_response: LLMResponseModel, output_path: str):
    ...
    heading.runs[0].font.size = 240000  # Font size 24 pt   
    heading.runs[0].font.bold = True    
    
    add_hr(heading) # Add a blank line   
    # Helper to add paragraphs or bullet lists
    ...
    add_hr(soapheader) # Add a blank line
    ...
    add_hr(clinicianheader) # Add a blank line
    ...
    add_hr(patientheader) # Add a blank line
    ...
    # add_section("Do’s and Don’ts", llm_response.Patient_Summary.Dos_and_Donts, bullet=True)
    ...
    if llm_response.Patient_Summary.Dos_and_Donts.Dos or llm_response.Patient_Summary.Dos_and_Donts.Donts:
        if llm_response.Patient_Summary.Dos_and_Donts.Dos:
           add_section("none", llm_response.Patient_Summary.Dos_and_Donts.Dos, bullet=True,emoji="✅")
            # for item in llm_response.Patient_Summary.Dos_and_Donts.Dos:
